...
namespace on.smfio
{
  ...
  /// </summary>
  public class SystemExclusiveVST : MIDIMessageVST
  {
    #region Properties
    ...
    #endregion
    public SystemExclusiveVST(long delta, int message, params byte[] data) : base(MidiMsgType.SequencerSpecific,delta,message,data)
    {
