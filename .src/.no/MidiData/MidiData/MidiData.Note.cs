...
namespace on.smfio
{
	...
	public class MidiNote : MidiData
	{
		...
		public MidiNote(byte? channel, byte key, ulong pulse, short noteOnVelocity) : this(channel,key,pulse,noteOnVelocity,-1)
		{
		}
		...
		/// <returns></returns>
		public MidiNote(byte? channel, byte key, ulong pulse, short noteOnVelocity, short noteOffVelocity) : base(channel,pulse)
		{
			this.K = key;
